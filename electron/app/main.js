(self["webpackChunklearn_project"] = self["webpackChunklearn_project"] || []).push([["main"],{
...
const routes = [
    { path: '', redirectTo: 'recipes', pathMatch: 'full' },
    {
        ...
        children: [
            {
                path: '',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_recipes_recipes-routing_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./recipes/recipes-routing.module */ 8969)).then(m => m.RecipesModule)
            }
        ]
    }
];
