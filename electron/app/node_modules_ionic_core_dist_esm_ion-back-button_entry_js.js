(self["webpackChunklearn_project"] = self["webpackChunklearn_project"] || []).push([["node_modules_ionic_core_dist_esm_ion-back-button_entry_js"],{
...
const BackButton = class {
  ...
  componentWillLoad() {
    if (this.defaultHref === undefined) {
      this.defaultHref = _ionic_global_eb4c4cce_js__WEBPACK_IMPORTED_MODULE_1__.c.get('backButtonDefaultHref');
    }
  }
  get backButtonIcon() {
    ...
    if ((0,_ionic_global_eb4c4cce_js__WEBPACK_IMPORTED_MODULE_1__.b)(this) === 'ios') {
      ...
      return _ionic_global_eb4c4cce_js__WEBPACK_IMPORTED_MODULE_1__.c.get('backButtonIcon', 'chevron-back');
    }
    // default md back button icon
    return _ionic_global_eb4c4cce_js__WEBPACK_IMPORTED_MODULE_1__.c.get('backButtonIcon', 'arrow-back-sharp');
  }
  get backButtonText() {
    const defaultBackButtonText = (0,_ionic_global_eb4c4cce_js__WEBPACK_IMPORTED_MODULE_1__.b)(this) === 'ios' ? 'Back' : null;
    return this.text != null ? this.text : _ionic_global_eb4c4cce_js__WEBPACK_IMPORTED_MODULE_1__.c.get('backButtonText', defaultBackButtonText);
  }
  get hasIconOnly() {
  ...
  render() {
    ...
    return ((0,_index_15bc22e8_js__WEBPACK_IMPORTED_MODULE_0__.i)(_index_15bc22e8_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, class: (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_2__.c)(color, {
        [mode]: true,
        'button': true,
      ...
      }) }, (0,_index_15bc22e8_js__WEBPACK_IMPORTED_MODULE_0__.i)("button", { type: type, disabled: disabled, class: "button-native", part: "native", "aria-label": backButtonText || 'back' }, (0,_index_15bc22e8_js__WEBPACK_IMPORTED_MODULE_0__.i)("span", { class: "button-inner" }, backButtonIcon && (0,_index_15bc22e8_js__WEBPACK_IMPORTED_MODULE_0__.i)("ion-icon", { part: "icon", icon: backButtonIcon, "aria-hidden": "true", lazy: false }), backButtonText && (0,_index_15bc22e8_js__WEBPACK_IMPORTED_MODULE_0__.i)("span", { part: "text", "aria-hidden": "true", class: "button-text" }, backButtonText)), mode === 'md' && (0,_index_15bc22e8_js__WEBPACK_IMPORTED_MODULE_0__.i)("ion-ripple-effect", { type: this.rippleType }))));
  }
